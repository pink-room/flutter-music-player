...
void main() {
    ...
    vec3 layer1 = mix(uColorPrimary, uColorSecondary, smoothstep(-.3, .2, (tuv * Rot(radians(-5.))).x));
    vec3 layer2 = mix(colorAccent1, colorAccent2, smoothstep(-.3, .2, (tuv * Rot(radians(-5.))).x));
